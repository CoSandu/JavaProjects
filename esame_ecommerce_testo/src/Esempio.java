...
public class Esempio {
	...
	public static void main(String[] args) throws EccezioneUtenteInesistente, IOException {
		...
		LinkedList<Prodotto> prodottiprezzo;
		prodottiprezzo = new LinkedList<Prodotto>(s.elencoProdottiPerPrezzo());
		for(Prodotto p : prodottiprezzo)
			System.out.println(" "+p.getCodice()+"; "+p.getNome()+"; "+p.getDescrizione()+"; "+p.getPrezzo());
